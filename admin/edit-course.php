...
$query = mysqli_query($con,"UPDATE course SET courseCode='$coursecode',
        courseName='$coursename',courseUnit='$courseunit',
        noofSeats='$seatlimit',updationDate='$currentTime'WHERE id='$id'");

if($query){

    $message = "<span class='alert alert-success'>Course Updated Successfully</span>";

}else{

    $message = "<span class='alert alert-danger'>Error : Course not Updated</span>";
 }
