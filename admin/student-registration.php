...
if($ret)
{
$message = '<span class="alert alert-success">Student Registered Successfully</span>';
}
else
{
  $message ='<span class="alert alert-danger">Error : Student  not Registered</span>';
}
}
?>
...
<head>
    ...
    <meta name="description" content="course registration system" />
