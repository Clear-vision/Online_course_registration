...
if(isset($_POST['submit']))
{
  ...
  $sql = mysqli_query($con,"INSERT  INTO department(department) values('$department')");
if($sql)
{

    $message = "<span class='alert alert-success'>Department Created Successfully</span>";
}else{

    $message = "<span class='alert alert-danger'>Error : Department not created</span>";
 }
}
if(isset($_GET['del']))
      {
          ...
          $message = "<span class='alert alert-danger'>Department deleted</span>";
      }
?>
