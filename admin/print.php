...
<body>
    <div class="invoice-box">
        ...
        $sql = mysqli_query($con,"SELECT course.courseName AS courname,
               ...
               students.studentName AS studentname,students.studentPhoto AS 
               photo,students.StudentRegno AS sregno,
               students.creationdate AS studentregdate FROM courseenrolls
   ...
   <?php } ?>
                            ...
                            <td>
                               ...
                               <b> Student Reg Date:</b> <?php echo htmlentities(date('F d, Y',strtotime($row['studentregdate'])));?><br>
                                <b> Student Course Enroll Date:</b> <?php echo htmlentities(date('F d, Y',strtotime($row['edate'])));?><br>
                            </td>
                        </tr>
                    </table>
                </td>
