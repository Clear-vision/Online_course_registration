...
if(isset($_POST['submit']))
{
  ...
  $query = mysqli_query($con,"INSERT INTO level(level) VALUES('$level')");
if($query)
{
    $message = "<span class='alert alert-success'>Level Created Successfully</span>";

}else{
    $message = "<span class='alert alert-danger'>Error : Level not created</span>";
...
if(isset($_GET['del']))
      {
          ...
          $message = "<span class='alert alert-danger'>Level deleted</span>";
      }
?>
