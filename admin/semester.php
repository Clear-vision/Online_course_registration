...
if($query){
    ...
    $message = "<span class='alert alert-success'>Semester Created Successfully</span>";
}else{

    $message = "<span class='alert alert-danger'>Error : Semester not created</span>";
}
}
if(isset($_GET['del']))
      {
          ...
          $message = "<span class='alert alert-danger'>semester deleted</span>";
      }
?>
