...
if(isset($_POST['submit'])) {
  ...
  $sesssion = mysqli_real_escape_string($con,$_POST['sesssion']);

$query = mysqli_query($con,"INSERT INTO session(session) VALUES('$sesssion')");

if($query){

    $message = "<span class='alert alert-success'>Session Created Successfully</span>";

}else {

    $message = "<span class='alert alert-danger'>Error : Session not created</span>";
 }
...
if(isset($_GET['del']))
      {
          ...
          $message = "<span class='alert alert-danger'>Session deleted</span>";
      }
?>
