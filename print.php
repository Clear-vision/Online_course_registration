...
<body>
    <div class="invoice-box">
        ...
        $sql = mysqli_query($con,"SELECT course.courseName AS courname,
            course.courseCode AS ccode,course.courseUnit AS cunit,
            session.session AS session,department.department AS dept,
            level.level AS level,courseenrolls.enrollDate AS edate,
            semester.semester AS sem ,students.studentName AS studentname,
