...
$query = mysqli_query($con,"INSERT INTO courseenrolls(studentRegno,pincode,session,department,level,course,semester)
 VALUES('$studentregno','$pincode','$session','$dept','$level','$course','$sem')");

if($query) {

    $message = "<span class='alert alert-success'>Enroll Successfully</span>";
}else {
    $message = "<span class='alert alert-danger'>Error : Not Enroll</span>";
}
}
?>
